<template>
    <div>
        <div class="rounded-lg bg-white ml-32 mr-32">
                    ...
                    <p class="flex justify-center text-center "><b>These are the first tools and technologies that I have worked with and have <br>knowledge of. I am clear that it is the beginning of many things that I have to learn.</b></p>

                   


                    <div class="grid grid-cols-8 p-12">
                            <a class="p-2">
                            ...
                            <a class="p-2">
                                <img class=" h-8" src="https://img.shields.io/badge/GIT-E44C30?style=for-the-badge&logo=git&logoColor=white"/>
                            </a>
                            <a class="p-2">
                                <img class=" h-8" src="https://img.shields.io/badge/Node.js-43853D?style=for-the-badge&logo=node.js&logoColor=white"/>
                            </a>
