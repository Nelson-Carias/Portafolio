    ...
    <div  class="">
        ...
        <div class="">
            ...
            <div class="flex justify-center">
                <img  width="200" height="300" src="https://mattfarley.ca/img/mf-avatar.svg">                
            </div>
            <br>
            <div class="flex justify-center">
                <img  width="600" src="https://mattfarley.ca/img/hero-devices.svg">
            </div>
            <div  class="bg-indigo-600">
                <div>
                    ...
                    <p  class="text-white text-center flex justify-center text-xl">I am a student, eager to learn and improve myself on a professional and personal level.<br>
                                                                            ...
                                                                            experience in new technologies and development tools.
                                                                            For me this is the beginning<br> of a lot of experience and knowledge that I will obtain as a professional.</p>
                </div>
                <br>
                <br>
